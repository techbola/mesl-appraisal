								...
								<tr>
									...
									<td class="v-align-middle">
										...
										@elseif($appraisal->sentFlag && $appraisal->status == 2)
											<a href="{{ route('supervisorViewGoals', ['id' => $appraisal->id]) }}" class="btn btn-info btn-sm">View Goals</a>
										@elseif(!$appraisal->sentFlag && $appraisal->status == 3 || !$appraisal->sentFlag && $appraisal->status == 5)
											<a href="{{ route('supervisorSubmitAppraisal', ['id' => $appraisal->id]) }}" class="btn btn-info btn-sm">Submit To Supervisor</a>
											|
											<a href="{{ route('supervisorDeleteAppraisal', ['id' => $appraisal->id]) }}" class="btn btn-danger btn-sm">Delete</a>
										...
										@else
											<a href="{{ route('supervisorSubmitAppraisal', ['id' => $appraisal->id]) }}" class="btn btn-info btn-sm">Submit To Supervisor</a>
											|
											<a href="{{ route('supervisorEditAppraisal', ['id' => $appraisal->id]) }}" class="btn btn-primary btn-sm">Edit</a>
											|
											<a href="{{ route('supervisorDeleteAppraisal', ['id' => $appraisal->id]) }}" class="btn btn-danger btn-sm">Delete</a>
										@endif
									...
									<td class="v-align-middle">
										...
										@elseif($appraisal->status == 5)
											<p>
												Rejected, by HR
												<br><br>
												<a href="{{ route('supervisorRejectedGoals', ['id' => $appraisal->id]) }}" class="btn btn-primary btn-sm">
													View Comment
												</a>
											</p>
